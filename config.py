...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Scrap_telegram_app_bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Scrap_telegram_app_bot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Scrap_telegram_app_bot")
